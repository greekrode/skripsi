        ...
        <div class="mCustomScrollbar" data-mcs-theme="dark">
            ...
            <ul class="chat-users">
                <li class="inline-items js-chat-open">
                    ...
                    <div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="{{ asset('svg/icons.svg') }}#olymp-three-dots-icon"></use></svg>

                        <ul class="more-icons">
                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="START CONVERSATION" class="olymp-comments-post-icon"><use xlink:href="{{ asset('svg/icons.svg') }}#olymp-comments-post-icon"></use></svg>
                            </li>

                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="ADD TO CONVERSATION" class="olymp-add-to-conversation-icon"><use xlink:href="{{ asset('svg/icons.svg') }}#olymp-add-to-conversation-icon"></use></svg>
                            </li>

                            <li>
                                <svg data-toggle="tooltip" data-placement="top" data-original-title="BLOCK FROM CHAT" class="olymp-block-from-chat-icon"><use xlink:href="{{ asset('svg/icons.svg') }}#olymp-block-from-chat-icon"></use></svg>
                            </li>
                        </ul>
