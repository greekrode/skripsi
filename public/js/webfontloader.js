! function() {
            ...
            if (0 === e.length && s) S(n.a);
                ...
                for (c = 0; c < e.length; c++) {
                    var l = e[c],
                        ...
                        p = n.a,
                        d = l;
                    if (p.g && r(p.f, [p.a.c("wf", d.c, x(d).toString(), "loading")]), C(p, "fontloading", d), p = null, null === st)
                        if (window.FontFace) {
    ...
    function Y(t) {
        for (var n = t.f.length, i = 0; i < n; i++) {
            ...
            if (2 <= e.length) {
                ...
                if (s = [], r = e[1])
                    for (var r = r.split(","), f = r.length, c = 0; c < f; c++) {
                        var h;
                        if ((h = r[c]).match(/^[\w-]+$/))
                            if (null == (u = lt.exec(h.toLowerCase()))) h = "";
                            else {
                                if (h = u[2], h = null == h || "" == h ? "n" : ht[h], null == (u = u[1]) || "" == u) u = "4";
                                else var l = ct[u],
            ...
            for (t.c[o] || (e = ft[o]) && (t.c[o] = e), e = 0; e < a.length; e += 1) t.a.push(new m(o, a[e]))
        }
    }
    ...
    q.prototype.g = function(t) {
        ...
        var n, i, e = this.a.urls || [],
            ...
            s = new p;
        for (n = 0, i = e.length; n < i; n++) l(this.c, e[n], d(s));
        var r = [];
        for (n = 0, i = o.length; n < i; n++)
            if ((e = o[n].split(":"))[1])
                for (var f = e[1].split(","), c = 0; c < f.length; c += 1) r.push(new m(e[0], f[c]));
        ...
        n ? u(this.c, (this.a.api || "https://use.typekit.net") + "/" + n + ".js", function(n) {
            if (n) t([]);
                ...
                for (var e = [], o = 0; o < n.length; o += 2)
                    for (var a = n[o], s = n[o + 1], r = 0; r < s.length; r++) e.push(new m(a, s[r]));
                try {
                    i.Typekit.load({
                        events: !1,
                        classes: !1,
